// custom types from https://github.com/developit/preact/pull/737
// which are a little bit better than the built in ones
...
declare namespace preact {
	...
	type RendableProps<P> = Readonly<P & { children?: JSX.Element[] }>;

	interface FunctionalComponent<PropsType> {
		(props: RendableProps<PropsType>, context?: any): VNode<any>;
		displayName?: string;
		defaultProps?: any;
	}
	...
	abstract class Component<PropsType, StateType> {
		...
		abstract render(props?: RendableProps<PropsType>, state?: Readonly<StateType>, context?: any): JSX.Element | null;
	}
